...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class HorizontalProductViewholder extends RecyclerView.ViewHolder {
        ...
        private void setHorizontalProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title, String color, List<WishlistModel> viewAllProductList) {
            ...
            HorizontalProductScrollAdapter horizontalProductScrollAdappter = new HorizontalProductScrollAdapter(horizontalProductScrollModelList);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(itemView.getContext());
            linearLayoutManager.setOrientation(RecyclerView.HORIZONTAL);
            horizontalRecyclerView.setLayoutManager(linearLayoutManager);
            horizontalRecyclerView.setAdapter(horizontalProductScrollAdappter);
            horizontalProductScrollAdappter.notifyDataSetChanged();
        }
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public GridProductViewHolder(@NonNull View itemView) {
            ...
            gridLayoutViewAllBtn = itemView.findViewById(R.id.grid_prooduct_layout_viewall_btn);
